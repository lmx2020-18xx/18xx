/* @ts-self-types="./rust_autorouter.d.ts" */
 ...
 * @param {Function} revenue_callback
 * @param {Function} progress_callback
 * @returns {string}
 */
export function find_best_routes(graph_json, revenue_callback, progress_callback) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(graph_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.find_best_routes(ptr0, len0, revenue_callback, progress_callback);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 * @returns {string}
 */
export function walk_paths(graph_json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(graph_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.walk_paths(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rust_autorouter_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
